...
void test_recorded_statistics()
{
    ...
    const RecordedStatistics statistics =
        calculate_recorded_statistics(samples, TimeRange{GpsTime{10}, GpsTime{30}});
    ...
    const RecordedStatistics empty =
        calculate_recorded_statistics(samples, TimeRange{GpsTime{50}, GpsTime{60}});
...
void test_expected_count()
{
    ...
    check(calculate_expected_sample_count(TimeRange{GpsTime{0}, GpsTime{1'000'000'000}}, 2.5) == 4,
    ...
    check(!calculate_expected_sample_count(TimeRange{GpsTime{20}, GpsTime{10}}, 1.0).has_value(),
    ...
    check(!calculate_expected_sample_count(TimeRange{GpsTime{0}, GpsTime{10}}, 0.0).has_value(),
